...
Converted["_Executor1"].Text = "Niggasploit:"
...
Converted["_Name1"].Text = "NiggaSploit 1.0.1"
...
Converted["_LPLRLAbel"].Text = "Miscellanous - NiggaSploit"
...
Converted["_TextLabel"].Text = "Editor - NiggaSploit"
...
Converted["_TextLabel1"].Text = "Script Hub - NiggaSploit"
...
local function BSQQK_fake_script() -- Fake Script: StarterGui.Bar.Blur.ExecutorFR.Execute.LocalScript
	...
	exec.MouseButton1Click:Connect(function()
		...
		if success then
			Converted["_TextLabel"].Text = "Editor - NiggaSploit (Script ran successfully!)"
			task.wait(0.4)
			Converted["_TextLabel"].Text = "Editor - NiggaSploit"
		else
